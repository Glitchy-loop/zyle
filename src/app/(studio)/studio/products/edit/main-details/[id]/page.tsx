...
import EditProductMainDetailsForm from "@/components/studio/forms/EditProductMainDetails"
...
const ProductEditMainDetailsPage = async ({ searchParams }: paramsProps) => {
...
export default ProductEditMainDetailsPage
